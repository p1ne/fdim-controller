...
void initStartMessages()
{
  ...
  start[START_COUNT++].set( 0, 100, 0, 0x3a0, 8, 0x45, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 );
...
//    start[START_COUNT++].set( 0, 250, 0, 0x3e8, 8, 0x00, 0x00, 0x29, 0x00, 0x00, 0x00, 0x00, 0x00 );
  ...
  if ( wantClock() )
    ...
    start[START_COUNT++].set( 0, 500, 1000, 0x3f2, 8, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00 ); // empty clock
...
void initCycleMessages()
{
  ...
  if (currentSettings.huType != HU_STOCK)
//    start[MSG_COUNT++].set( 0, 250, 0, 0x3e8, 8, 0x00, 0x00, 0x29, 0x00, 0x00, 0x00, 0x00, 0x00 );
    start[MSG_COUNT++].set( 0, 250, 0, 0x3e8, 8, 0x00, 0x00, 0x04, 0x24, 0x00, 0x00, 0x00, 0x00 );
  ...
  if (currentSettings.huType != HU_STOCK) {
    if ( wantClock() && ( currentSettings.huType == HU_AFTERMARKET) )
      ...
      start[MSG_COUNT++].set( 0, 500, 1000, 0x3f2, 8, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00 ); // empty clock
  }
}
