...
{
  tpms[0].set( 0,   0,  300, 0x726, 8, 3, 0x22, 0x41, 0x40, 0x00, 0x00, 0x00, 0x00 );  // Front
  tpms[1].set( 0, 150,  300, 0x726, 8, 3, 0x22, 0x41, 0x41, 0x00, 0x00, 0x00, 0x00 );  // Rear
  tpms[2].set( 0, 200, 1000, 0x726, 8, 3, 0x22, 0x41, 0x60, 0x00, 0x00, 0x00, 0x00 );  // Temperature
