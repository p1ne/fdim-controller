...
void initTextMessages()
{
  ...
  text[ 2].set( 0,  60, 0x337, 8, 0x06, 0x20, 0x20, 0x40, 0x20, 0x40, 0x20, 0x00 );
  ...
  text[ 5].set( 0,  20, 0x337, 8, 0x10, 0x2B, 0x20, 0x20, 0x20, 0x40, 0x20, 0x20 );
  text[ 6].set( 0,  20, 0x337, 8, 0x21, 0x20, 0x4D, 0x65, 0x72, 0x63, 0x40, 0x75 );
  text[ 7].set( 0,  20, 0x337, 8, 0x22, 0x72, 0x79, 0x20, 0x20, 0x20, 0x20, 0x20 );
  text[ 8].set( 0,  20, 0x337, 8, 0x23, 0x20, 0x20, 0x20, 0x20, 0x20, 0x40, 0x20 );
  text[ 9].set( 0,  20, 0x337, 8, 0x24, 0x20, 0x20, 0x4d, 0x61, 0x72, 0x69, 0x6e );
  text[10].set( 0,  20, 0x337, 8, 0x25, 0x65, 0x72, 0x20, 0x20, 0x20, 0x20, 0x20 );
  text[11].set( 0,  20, 0x337, 8, 0x26, 0x20, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00 );
}
